Clients repository for the Solutions for Open Land Administration
(SOLA) open source project. This repository contains the 
SOLA Web Admin client application.
